  ...
  return (
    <div className="relative m-4 flex h-fit w-[30rem] min-w-[24rem] justify-between rounded-md bg-neutral-50 p-4 shadow-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          className={`w-30 absolute m-4 h-10 rounded-full border-2 border-teal-500 px-4 text-xs font-bold text-neutral-900 ${
